...
class RainbowDQN:
    """
    Implementation of Google Deepmind's "Rainbow" DQN.
    This agent can be used to train a varienty of distributional DQNs
    trained with train_dqn.py after changing the desired values in
    parameters.py. Additionally, training with "train_rainbow.py" will
    ensure this agent is a complete "Rainbow" DQN. The complete rainbow
    DQN includes: 
        - Double DQN
        - Dueling DQN
    ...
    def act(self, input_state):
        ...
        based on the current DQN model, with randomness built into
        the "noisy" network.
